...
test.describe("@Author-Shriti S Verify that clicking on Integration name hyperlink navigates to integration page", () => {
  ...
  test("@Epic-IO-31713 @Priority-P2 @Zephyr-IO-T29018 @Zephyr-IO-T29022 Verify that clicking on Integration name hyperlink navigates to integration page", async ({ io, page }) => {
