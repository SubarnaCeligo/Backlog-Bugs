...
test.describe("@Author-Shriti S Verify all the elements of EDI Dashboard", () => {
  ...
  test("@Epic-IO-31713 @Priority-P1 @Zephyr-IO-T28999 @Zephyr-IO-T29000 @Zephyr-IO-T29004 @Zephyr-IO-T29029 Verify all the elements of EDI Dashboard", async ({ io, page }) => {
