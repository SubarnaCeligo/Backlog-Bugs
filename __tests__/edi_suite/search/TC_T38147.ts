...
test.describe("@Author-Shriti S Verify that at least 3 characters are required in the search term to perform full text search on EDI dashboard", () => {
  ...
  test("@Env-All @Epic-IO-85710 @Priority-P2 @Zephyr-IO-T38147 Verify that at least 3 characters are required in the search term to perform full text search on EDI dashboard", async ({ io, page }) => {
