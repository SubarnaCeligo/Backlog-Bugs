...
test.describe("@Author-Shriti S Verify case-insensitive and regex search together", () => {
  ...
  test("@Env-QA @Env-IAQA @Epic-IO-85710 @Priority-P2 @Zephyr-IO-T38151 Verify case-insensitive and regex search together", async ({ io, page }) => {
    ...
    await io.homePage.fill(selectors.dashboardPagePO.EDI_SEARCH_BOX, regexDocumentNumber.toLowerCase());
