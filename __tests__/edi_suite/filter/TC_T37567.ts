...
test.describe("@Author-Shriti S Verify that EDI transactions can be filtered using multiple Direction values", () => {
  ...
  test("@Env-QA @Env-IAQA @Epic-IO-89826 @Priority-P2 @Zephyr-IO-T37567 Verify that EDI transactions can be filtered using multiple Direction values", async ({ io, page }) => {
