...
test.describe("@Author-Shriti S Verify that EDI transactions can be filtered using single Direction value", () => {
  ...
  test("@Env-QA @Env-IAQA @Epic-IO-89826 @Priority-P2 @Zephyr-IO-T37566 Verify that EDI transactions can be filtered using single Direction value", async ({ io, page }) => {
