...
test.describe("TC_C22555", () => {
  ...
  test("TC_C22555", async ({io,page}, testInfo) => {
...
, async ()=>{});
    var conn = ZS1["connectionId"];
    conn = io.connMap.get(conn);

    await io.homePage.fillWebPage(
      selectors.basePagePO.CONNECTION,
      conn
    );
await test.step(
