...
test.describe("TC_C40126", () => {
  ...
  test("TC_C40126", async ({io,page}, testInfo) => {
    ...
    await io.assert.expectToContainValue(selectors.integrationPagePO.TABLEBODY, "Don't use", "");
    await io.assert.expectToContainValue(selectors.integrationPagePO.TABLEBODY, "No flows have been added to this group.", "");
    await io.assert.expectToContainValue(selectors.integrationPagePO.TABLEBODY, "Don't use1", "");
    await io.assert.expectToContainValue(selectors.integrationPagePO.TABLEBODY, "No flows have been added to this group.", "");
