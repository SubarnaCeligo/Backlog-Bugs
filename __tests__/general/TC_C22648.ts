...
test.describe("TC_C22648", () => {
  ...
  test("TC_C22648_Verify_the_Clone_page", async ({io,page}, testInfo) => {
    await io.goToFlowsPage();
    ...
    var input7 = await io.homePage.isVisible(selectors.basePagePO.CONNECTIONS);
    await io.assert.expectToBeTrue(input7, "");
