...
test.describe("TC_C1102_C1103_Verify_Updating_Offline_Connection", () => {
  ...
  test.beforeEach(async ({io,page}, testInfo) => {
    ...
    await io.homePage.clickButtonByIndex(selectors.flowBuilderPagePO.INTEGRATIONTABNAME, 3);
    await test.step("*** Go to connections tab ***",()=>{});
    await io.homePage.isPageLoaded();
    await io.homePage.isPageReady();
    await io.homePage.clickButtonByIndex(selectors.basePagePO.INVITEUSER, 2);
    ...
    await io.homePage.fillWebPage(selectors.basePagePO.NAME, "DND_Do_Not_Modify");
    await test.step("*** Providing Connection Name ***",()=>{});
    await io.homePage.selectDropdownBasedOnAttribute(selectors.connectionsPagePO.SF_ACCOUNTTYPE, "Production");
    ...
    await io.homePage.fillWebPage(selectors.flowBuilderPagePO.SALESFORCE_USERNAME, "testing");
