...
test.describe("TC_C31614_C27901", () => {
  ...
  test("TC_C31614_C27901", async ({io,page}, testInfo) => {
    ...
    var close_btn = await io.assert.checkElementState(selectors.basePagePO.CLOSE_RIGHT_DRAWER, "isDisabled");
    ...
    await io.assert.expectToBeValue(String(title), "Developer playground", "");
