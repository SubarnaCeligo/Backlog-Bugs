...
test.describe(`IO-T27292 Verify the user is able to see the existing "Access token path" moved from "Configure token auth" field to “OAuth 2.0 overrides” field`, () => {
  test('@Env-QA @Zephyr-IO-T27292  Verify the user is able to see the existing "Access token path" moved from "Configure token auth" field to “OAuth 2.0 overrides” field', async ({
    io,
    page
  }) => {
