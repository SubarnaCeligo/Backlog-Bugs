...
test.describe("@Author-Shriti S Verify the search results and app counts message with a search term that matches both IAs and templates", () => {
  ...
  test("@Env-QA @Epic-IO-51028 @Priority-P2 @Zephyr-IO-T31825 Verify the search results and app counts message with a search term that matches both IAs and templates", async ({ io, page }) => {
