...
test.describe("TC_T28431_Test to validate checkbox is visible in HTTP export/lookup if we have exportSuccessMediaType is do not override and connectionSuccessMediaType is do not override and connectionMediaType is json", () => {
    ...
    test("@Epic-IO-37655 @Priority-P2 @Zephyr-T28431 @author_Sagna TC_T28431", async ({ io, page }) => {
        ...
        await io.homePage.fill(selectors.basePagePO.NAME, "HTTP CONNECTION WITH DO NOT OVERRIDE AS SUCCESS MEDIA TYPE AND JSON AS MEDIA TYPE");
        ...
        await io.homePage.goToMenu("Resources","Connections");
        await io.homePage.addStep("*** Navigated back to connection page ***");
        await io.homePage.fill(selectors.connectionsPagePO.CONNECTION_PAGE_SEARCH_BAR, "HTTP CONNECTION WITH DO NOT OVERRIDE AS SUCCESS MEDIA TYPE AND JSON AS MEDIA TYPE");
        await io.homePage.loadingTime()
