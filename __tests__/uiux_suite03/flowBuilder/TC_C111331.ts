...
test.describe("TC_C111331", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("TC_C111331 @Zephyr-IO-T8855 @Env-All @Priority-P2", async ({ io, page }) => {
        ...
        await io.homePage.addStep("*** Clicked on destination field and verified the dropdown with destination fields from postgre ***");
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
