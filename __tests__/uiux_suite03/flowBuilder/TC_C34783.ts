...
test.describe('C34783 UI is crashing when we select mapping option at page processor after refreshing the browser in Orchestration Flow.', () => {
    ...
    test('"@Zephyr-IO-T9703 @Env-All C34783 UI is crashing when we select mapping option at page processor after refreshing the browser in Orchestration Flow.', async ({ io, page }) => {
        // create a flow
