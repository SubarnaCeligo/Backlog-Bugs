...
test.describe("TC_T28432_Test to validate checkbox is not visible in HTTP export/lookups if we have exportSuccessMediaType is do not override and connectionSuccessMediaType is do not override and connectionMediaType is other than json", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("@Epic-IO-37655 @Priority-P2 @Zephyr-T28432 @Env-QA @author_Sagna TC_T28432", async ({ io, page }) => {
        ...
        await io.homePage.fill(selectors.basePagePO.NAME, "HTTP CONNECTION WITH XML AS MEDIA TYPE");
        ...
        await io.homePage.addStep("*** Clicked on connection media type ***");
        ...
        await io.homePage.click(selectors.flowBuilderPagePO.HTTP_FORM_SWITCH);
        await io.homePage.addStep("*** Selected HTTP application ***");
        await io.flowBuilder.fill(selectors.connectionsPagePO.CONNECTION_INPUT, "HTTP CONNECTION WITH XML AS MEDIA TYPE");
        await io.homePage.addStep("*** Searched for HTTP CONNECTION WITH XML AS MEDIA TYPE ***");
        await io.homePage.clickByText('HTTP CONNECTION WITH XML AS MEDIA TYPE');
        await io.homePage.addStep("*** Selected HTTP CONNECTION WITH XML AS MEDIA TYPE ***");
        ...
        await io.homePage.goToMenu("Resources","Connections");
        await io.homePage.addStep("*** Navigated back to connection page ***");
        await io.homePage.fill(selectors.connectionsPagePO.CONNECTION_PAGE_SEARCH_BAR, "HTTP CONNECTION WITH XML AS MEDIA TYPE");
        await io.homePage.loadingTime()
