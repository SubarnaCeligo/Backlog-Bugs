...
test.describe("@Author_sagna123 TC_T28432_Test to validate checkbox is not visible in HTTP export/lookups if we have exportSuccessMediaType is do not override and connectionSuccessMediaType is do not override and connectionMediaType is other than json", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("@Epic-IO-37655 @Priority-P2 @Zephyr-IO-T28432 @Env-QA", async ({ io, page }) => {
