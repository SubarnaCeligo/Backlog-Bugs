...
test.describe(`TC_IOT26994 Test to validate that user is able to close the help text by clicking on "X"/cross icon in google sheets export/lookup`, () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });

    test("IOT26994", async ({ io, page}) => {
