...
import data1 from "@testData/ScriptDebugger/C93685.json"


test.describe('C93685 Validate user is getting auto-fill of funtion stub while creating "branching" script through flow builder branching filter', () => {
   
    test('@Env-All @Zephyr-IO-T22652 C93685 Validate user is getting auto-fill of funtion stub while creating "branching" script through flow builder branching filte', async({io,page}) => {
     ...
     await io.flowBuilder.clickByTextByIndex("Branching script",0)
