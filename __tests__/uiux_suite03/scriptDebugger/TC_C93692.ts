...
test.describe('C93692 Validate that user is able to see "formInit" function in “Insert function stub” field while creating a script (Manage)', () => {
  test('@Env-All @Zephyr-IO-T22659 C93692 Validate that user is able to see "formInit" function in “Insert function stub” field while creating a script (Manage)', async ({io,page}) => {
