...
test.describe.skip("C32975 To verify 'Monitor' label is displayed along with integration name if that particular integration has only monitor access permission", () => {
    test("C32975 To verify 'Monitor' label is displayed along with integration name if that particular integration has only monitor access permission @Env-All @Priority-P2", async ({io, page}) => {
