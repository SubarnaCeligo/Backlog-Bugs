...
test.describe("TC_C111335", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("TC_C111335 @Zephyr-IO-T8858 @Env-All @Priority-P2", async ({ io, page }) => {
        ...
        await io.homePage.addStep("*** Clicked on search button and checked the Actions to take field ***");
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
