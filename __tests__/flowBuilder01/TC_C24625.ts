...
test.describe("C24625_Verify the behaviour of Retry & Resolve dropdown with <1000 errors on account with Admin permission", () => {
    ...
    test("@Env-All @Zephyr-IO-T7219 C24625_Verify the behaviour of Retry & Resolve dropdown with <1000 errors on account with Admin permission UI_Backlog", async ({ io, page, }) => {
