...
test.describe("TC_C110672_Test to validate we are getting AFE auto suggestion drawer when we click Ctrl/Cmd+space on mapper2.0 field level ", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("C110672 @Zephyr-IO-T15682 @Env-All @Priority-P2", async ({ io, page }) => {
