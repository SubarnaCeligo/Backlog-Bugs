...
test.describe("TC_C110680_Test to validate AFE auto suggestion features are working fine at transformation2.0 Sandbox", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("C110680 @Env-All @Priority-P2 @Zephyr-IO-T15690", async ({ io, page }) => {
