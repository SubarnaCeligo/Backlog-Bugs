...
test.describe("TC_C111344", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("TC_C111344 @Env-All @Priority-P2", async ({ io, page }) => {
        ...
        await io.homePage.addStep("*** Verified we are getting 'QA_Automation.public.Anusha Table1' as table name ***");
