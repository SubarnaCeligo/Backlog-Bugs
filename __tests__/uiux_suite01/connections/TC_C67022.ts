...
test.describe("C67022 To verify that the Dialogue/Iframe is displayed when there is no matching for searched connection name in the connections page", () => {
    test("@Zephyr-IO-T24310 C67022 To verify that the Dialogue/Iframe is displayed when there is no matching for searched connection name in the connections page", async ({io, page}) => {
