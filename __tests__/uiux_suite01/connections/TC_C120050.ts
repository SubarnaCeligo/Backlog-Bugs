...
test.describe("TC_C120050", () => {
  test("@Env-All @Zephyr-IO-T18651 C120050 Override media type for success responses field should have Plain text option", async ({ io, page }) => {
