...
test.describe("TC_C120048", () => {
  test("@Env-All @Zephyr-IO-T18650 C120048  Related fields should show when Media type is Plain text and override media type for success responses is JSON or XML", async ({ io, page }) => {
