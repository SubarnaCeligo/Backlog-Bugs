...
test.describe(`C68717 Verify user is able to create connection for NS JDBC connector(Basic auth) from previously created export/lookup`, () => {
  test(`@Env-QA @Zephyr-IO-T8440 C68717 Verify user is able to create connection for NS JDBC connector(Basic auth) from previously created export/lookup`, async ({
    io,
    page
  }) => {
