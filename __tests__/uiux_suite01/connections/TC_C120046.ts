...
test.describe("TC_C120046", () => {
  test("@Env-All @Zephyr-IO-T18648 C120046  Related fields should present when Media type is Plain text and override media types are JSON or XML", async ({ io, page }) => {
