...
test.describe("TC_C120052", () => {
  test("@Env-All  @Zephyr-IO-T18653 C120052 Override media type for error responses field should have Plain text option", async ({ io, page }) => {
