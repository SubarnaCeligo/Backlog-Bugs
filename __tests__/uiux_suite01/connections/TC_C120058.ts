...
test.describe("TC_C120057", () => {
  test("@Env-All @Zephyr-IO-T18658 C120057 If Media type is Plain text then Override media type for success responses field should not have Plain text option", async ({ io, page }) => {
