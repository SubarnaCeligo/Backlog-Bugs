...
test.describe("C67220 Verify Auto-place the cursor in the search bar on the following places: Marketplace, Home Page, Integration Flows page", () => {
  test("@Env-QA @Zephyr-IO-T19858 C67220 Verify Auto-place the cursor in the search bar on the following places: Marketplace, Home Page, Integration Flows page", async ({
    io,
    page
  }) => {
