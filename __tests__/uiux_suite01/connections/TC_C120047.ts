...
test.describe("TC_C120047", () => {
  test("@Env-All @Zephyr-IO-T18649 C120047  Related fields should show when Media type is Plain text and override media type for error responses is JSON or XML", async ({ io, page }) => {
