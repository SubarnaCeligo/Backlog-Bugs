...
test.describe(`C113520_C113521_C113522_C113523_C113524_C113525_C113526`, () => {
  ...
  test(`@Env-QA @Env-IAQA @Zephyr-IO-T7775 @Zephyr-IO-T7776 @Zephyr-IO-T7777 @Zephyr-IO-T7778 @Zephyr-IO-T7779 @Zephyr-IO-T7780 @Zephyr-IO-T7781 Normal HTTP 2.0 framework connectors`, async ({ io, page }) => {
  ...
  test(`@Env-All @Zephyr-IO-T7775 @Zephyr-IO-T7776 @Zephyr-IO-T7777 @Zephyr-IO-T7778 @Zephyr-IO-T7779 @Zephyr-IO-T7780 @Zephyr-IO-T7781 HTTP connection iClient page`, async ({ io, page }) => {
    await io.connectionPage.navigateTo(io.data.links.CONNECTIONS_PAGE_URL);
    await io.connectionPage.click(selectors.connectionsPagePO.CREATE_CONNECTION);
  ...
  test(`@Env-All @Zephyr-IO-T7775 @Zephyr-IO-T7776 @Zephyr-IO-T7777 @Zephyr-IO-T7778 @Zephyr-IO-T7779 @Zephyr-IO-T7780 @Zephyr-IO-T7781 REST connection iClient page`, async ({ io, page }) => {
    await io.connectionPage.navigateTo(io.data.links.CONNECTIONS_PAGE_URL);
    await io.connectionPage.click(selectors.connectionsPagePO.CREATE_CONNECTION);
  ...
  test(`@Env-QA  @Env-IAQA  @Zephyr-IO-T7775 @Zephyr-IO-T7776 @Zephyr-IO-T7777 @Zephyr-IO-T7778 @Zephyr-IO-T7779 @Zephyr-IO-T7780 @Zephyr-IO-T7781 Auth2.0 supported connector iClient page`, async ({ io, page }) => {
  ...
  test(`@Env-All @Zephyr-IO-T7775 @Zephyr-IO-T7776 @Zephyr-IO-T7777 @Zephyr-IO-T7778 @Zephyr-IO-T7779 @Zephyr-IO-T7780 @Zephyr-IO-T7781 Resource iClient Page`, async ({ io, page }) => {
