...
test.describe("C107439_C106998 Verify the Sort Errors in new error view in Ascending and Descending Timestamp", () => {
  ...
  test("@Zephyr-IO-T1657 @Zephyr-IO--IO-T1653 @Env-QA @Env-STAGING C107439_C106998 Verify user can able to toggle sorting arrow and view changes", async ({ io, page }) => {
