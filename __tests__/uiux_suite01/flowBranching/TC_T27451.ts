...
test.describe('@Bug-IO-67538  @Priority-P2 @Zephyr-IO-T27451 Verify On moving from javascript mode to rules mode, test run results errors dont clear up', () => {
    ...
    test('@Env-All @Bug-IO-67538  @Priority-P2 @Zephyr-IO-T27451  Verify On moving from javascript mode to rules mode, test run results errors dont clear up', async ({ io, page }) => {
