...
test.describe("C26030_When debugger is on, log out of IO, log in again, open the debug logs, (you shd see debug time remaining), (send a new log entry), refresh should enable after that_UI_Backlog", () => {
    ...
    test("C26030_When debugger is on, log out of IO, log in again, open the debug logs, (you shd see debug time remaining), (send a new log entry), refresh should enable after that_UI_Backlog", async ({ io }) => {
