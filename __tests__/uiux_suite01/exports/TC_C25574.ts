...
test.describe("C25574_Verify 'debug logs' button is displayed in top right of the webhooks and listener drawer", () => {
    ...
    test("@Env-All @Zephyr-IO-T4836 Verify 'debug logs' button is displayed in top right of the webhooks and listener drawer UI_Backlog", async ({ io }) => {
        ...
        await io.flowBuilder.fill(selectors.connectionsPagePO.NAME_INPUT, 'TC_C25574');
        ...
        // Validating View listener debug logs and view debug log available in webhook
