...
test.describe("C19744_All the AFE panels should open on the right side of the page_UI_Backlog", () => {
    ...
    test("C19744_All the AFE panels should open on the right side of the page_UI_Backlog", async ({ io, page }) => {
