...
test.describe("C19743_Export Panel: Color code Export panel request/response/output like in the AFEs_UI_Backlog", () => {
    ...
    test("C19743_Export Panel: Color code Export panel request/response/output like in the AFEs_UI_Backlog", async ({ io, page }) => {
