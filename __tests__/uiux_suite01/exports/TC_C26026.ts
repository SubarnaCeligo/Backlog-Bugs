...
test.describe("C26026_Verify 'View debug logs' not visible non-RT exports or imports_UI_Backlog", () => {
    ...
    test("C26026_Verify 'View debug logs' not visible non-RT exports or imports_UI_Backlog", async ({ io, page }) => {
