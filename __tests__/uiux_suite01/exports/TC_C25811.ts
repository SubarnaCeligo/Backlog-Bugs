...
test.describe("C25811_Verify that View listener debug logs drawer is displayed properly without any overlap issue when sidepane is minimized_UI_Backlog", () => {
    ...
    test("C25811_Verify that View listener debug logs drawer is displayed properly without any overlap issue when sidepane is minimized_UI_Backlog", async ({ io}) => {
