...
test.describe("C25998_VVerify stop button is not shown when the debug duration has expired_UI_Backlog", () => {
    ...
    test("C25998_VVerify stop button is not shown when the debug duration has expired_UI_Backlog", async ({ io, page }) => {
