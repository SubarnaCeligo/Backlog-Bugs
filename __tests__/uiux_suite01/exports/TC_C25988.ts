...
test.describe("C25988_Verify the debug remaining time is shown if the debug is still running_UI_Backlog", () => {
    ...
    test("C25988_Verify the debug remaining time is shown if the debug is still running_UI_Backlog", async ({ io, page }) => {
