...
test.describe("C26004_Verify when clicked on close button  x on the drawer, I am back on the edit listener configuration page_UI_Backlog", () => {
    ...
    test("C26004_Verify when clicked on close button  x on the drawer, I am back on the edit listener configuration page_UI_Backlog", async ({ io, page }) => {
