...
test.describe("C106842_Test to validate that the user is getting help text, help syntax, able to edit the expression, and should be able to select any item from the Fields section and include it in the expression -->>FTP Connection/export/import/lookup", () => {
    ...
    test("@Env-All @Zephyr-IO-T1647 C106842_Test to validate that the user is getting help text, help syntax, able to edit the expression, and should be able to select any item from the Fields section and include it in the expression -->>FTP Connection/export/import/lookup UI_Backlog", async ({ io, page }) => {
