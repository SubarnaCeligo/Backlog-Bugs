...
test.describe("C26029_When debugger is on, refresh got enabled after new entry, user clicks on refresh logs, now refresh button should be disabled, (send a new log entry), again refresh button would be enabled", () => {
    ...
    test("C26029_When debugger is on, refresh got enabled after new entry, user clicks on refresh logs, now refresh button should be disabled, (send a new log entry), again refresh button would be enabled", async ({ io, page }) => {
