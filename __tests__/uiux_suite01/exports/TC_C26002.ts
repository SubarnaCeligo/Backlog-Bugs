...
test.describe("C26002_verify able to refresh the debuglogs page_UI_Backlog", () => {
    ...
    test("C26002_verify able to refresh the debuglogs page_UI_Backlog", async ({ io, page }) => {
