...
test.describe("C53030 Verify that the 30 days option is enable for for license type is of Free tier, Free trial, Standard subscriptions", () => {
    test("@Env-STAGING @Env-IAQA C53030 Verify that the 30 days option is enable for for license type is of Free tier, Free trial, Standard subscriptions", async ({io, page}) => {
