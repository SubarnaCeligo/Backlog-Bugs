...
test.describe("TC_C119817", () => {
    ...
    test("TC_C119817", async ({ io, page }) => {
       ...
       //IMPORT
        ...
        await io.assert.expectToBeFalse(await (await page.locator(selectors.flowBuilderPagePO.EXISTINGRECORDSIMPORT)).isVisible(), "How would you like the records imported? is not hidden");
        //-'Custom settings' should be renamed to 'Settings'.
