...
test.describe(`C32362 Verify cloned integration has the updated flow after updating the settings`, () => {
  test(`@Env-QA  @Zephyr-IO-T5337 @Zephyr-IO-T123456789 @Zephyr-IO-T1 @Zephyr-IO-T5337 C32362 Verify cloned integration has the updated flow after updating the settings`, async ({
    io,
    page
  }) => {
