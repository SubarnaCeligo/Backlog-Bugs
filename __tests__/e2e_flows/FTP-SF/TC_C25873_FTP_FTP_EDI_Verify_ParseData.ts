...
import * as FTPtoFTP from "@testData/Flows/create/ftp/TC_C25873_FTP_FTP_EDI_Verify_ParseData.json"
...
test.describe("E2E Flows", () => {
    ...
    test("@Env-all TC_C25873_FTP_FTP_EDI_Verify_ParseData", async ({
        io
    }, testInfo) => {
