...
import FTP from "@testData/Flows/create/ftp/TC_492_FTP_SortAndGroup_NestedJson_To_FTP_Import.json"
...
test.describe("E2E Flows", () => {
    ...
    test("@Env-all TC_492_FTP_SortAndGroup_NestedJson_To_FTP_Import", async ({
        io
    }, testInfo) => {
