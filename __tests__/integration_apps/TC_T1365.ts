...
test.describe("T1365 Verify whether mapper1.0/mapper2.0 toggle is removed for IA's @Epic-IO-68924 @Priority-P3 @Zephyr-IO-T1365 @author_Kaushik UI_Backlog @Env-IAQA", () => {
  ...
  test("T1365 Verify whether mapper1.0/mapper2.0 toggle is removed for IA's @Epic-IO-68924 @Priority-P3 @Zephyr-IO-T1365 @author_Kaushik UI_Backlog @Env-IAQA", async ({ io, page }) => {
