...
test.describe("T1365 Verify whether mapper1.0/mapper2.0 toggle is removed for IA's @author_Kaushik UI_Backlog @Env-IAQA", () => {
  test.beforeEach(async ({ io }) => {
    await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("T1365 Verify whether mapper1.0/mapper2.0 toggle is removed for IA's @author_Kaushik UI_Backlog @Env-IAQA", async ({ io, page }) => {
