...
import iaqa_script from "@testData/integration_apps/iaqa_script.json";
...
test.describe("C27460 To verify below schema is displayed for exports present1 in child IA", () => {
  ...
  test("@Env-All @Zephyr-IO-T5459 C27460 To verify below schema is displayed for exports present in child IA", async ({
    io,
    page
  }) => {
