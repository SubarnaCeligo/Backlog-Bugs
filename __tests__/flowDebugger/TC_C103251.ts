...
import TC from "../../testData/inputData/FlowDebugger/TC_C103251.json";

test.describe("TC_C103251_SuiteApp_WithMockData", async () => {
  ...
  test("@Env-All @Zephyr-IO-T24527 TC_C103251_SuiteApp_WithMockData", async ({ io, page }) => {
    ...
    //   console.log("Mahesh", col1);
    //   let expectedText = `Batch ${i + 1}`;
    //   console.log("Mahesh Sutar", expectedText);
