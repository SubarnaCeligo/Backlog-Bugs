...
import FTP from "@testData/STANDALONE/TC_C33399_Verify_DirectoryPath_FTPImport_output_Premap_Hook.json";
test.describe("TC_C33399_Verify_DirectoryPath_FTPImport_output_Premap_Hook", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5553 TC_C33399_Verify_DirectoryPath_FTPImport_output_Premap_Hook", async ({io,page}, testInfo) => {
    ...
    await io.homePage.loadingTime();
    await io.homePage.isPageReady();
    test.step("*** Clicking on DirectoryPath handlebar ***", async ()=>{});
