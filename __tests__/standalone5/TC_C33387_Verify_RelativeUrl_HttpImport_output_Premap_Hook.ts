...
import HTTP from "@testData/STANDALONE/TC_C33387_Verify_RelativeUrl_HttpImport_output_Premap_Hook.json";
test.describe("TC_C33387_Verify_RelativeUrl_HttpImport_output_Premap_Hook", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5543 TC_C33387_Verify_RelativeUrl_HttpImport_output_Premap_Hook", async ({io,page}, testInfo) => {
