...
import FTP from "@testData/STANDALONE/TC_C33411_Azure_premap_script_validation_BackupPath.json";
test.describe("TC_C33411_Azure_premap_script_validation_BackupPath", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5561 TC_C33411_Azure_premap_script_validation_BackupPath", async ({io,page}, testInfo) => {
