...
import FTP from "@testData/STANDALONE/TC_C33395_Verify_Filename_FTPImport_output_Premap_Hook.json";

test.describe("TC_C33395_Verify_Filename_FTPImport_output_Premap_Hook", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5550 TC_C33395_Verify_Filename_FTPImport_output_Premap_Hook", async ({io,page}, testInfo) => {
