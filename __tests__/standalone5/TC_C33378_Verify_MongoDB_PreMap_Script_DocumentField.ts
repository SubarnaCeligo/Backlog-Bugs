...
import FTP from "@testData/STANDALONE/TC_C33378_Verify_MongoDB_PreMap_Script_DocumentField.json";
test.describe("TC_C33378_Verify_MONGODB_PreMap_Script_DocumentField", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5535 TC_C33378_Verify_MongoDB_PreMap_Script_DocumentField", async ({io,page}, testInfo) => {
    ...
    await io.homePage.loadingTime();
    await io.homePage.isPageReady();
    test.step("*** Clicking on Back up path handlebar ***", async ()=>{});
