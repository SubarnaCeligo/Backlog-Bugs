...
import HTTP from "@testData/STANDALONE/TC_C33389_Verify_RelativeURI_RestImport_output_Premap_Hook.json";

test.describe("TC_C33389_Verify_RelativeURI_RestImport_output_Premap_Hook", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5545 TC_C33389_Verify_RelativeURI_RestImport_output_Premap_Hook", async ({io,page}, testInfo) => {
    ...
    await io.homePage.loadingTime();
    await io.homePage.isPageReady();
    test.step("*** Clicking on Rest Import button ***", async ()=>{});
    ...
    test.step("*** Clicked on Rest RelativeUri Openhandler ***", async ()=>{});
    test.step("*** Verifying  Relative URI data is Output of Premapscript applied", async ()=>{});
    await io.homePage.loadingTime();
    await io.homePage.isPageReady();
