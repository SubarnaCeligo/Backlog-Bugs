...
test.describe("TC_C33386_Verify_QueryBuilder_RDBMSImport_output_Premap_Hook", () => {
  let flowID;
  ...
  test("@Env-All @Zephyr-IO-T5542 TC_C33386_Verify_QueryBuilder_RDBMSImport_output_Premap_Hook", async ({io,page}, testInfo) => {
    ...
    test.step("*** Clicking on RDBMS Query handlebar ***", async ()=>{});
    ...
    test.step("*** Clicking on RDBMS Query Handlebar close button ***", async ()=>{});
