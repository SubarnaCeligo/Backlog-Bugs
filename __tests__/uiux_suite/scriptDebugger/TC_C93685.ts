...
test.describe('C93685 Validate user is getting auto-fill of funtion stub while creating "branching" script through flow builder branching filter', () => {
    ...
    test('Validate user is getting auto-fill of funtion stub while creating "branching" script through flow builder branching filte', async({io,page}) => {
     ...
     await page.getByText("Branching script").first().click(); // Adjust the position [1] as needed
