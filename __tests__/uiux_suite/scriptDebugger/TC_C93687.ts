...
test.describe('C93687 Validate user is getting auto-fill of funtion stub while creating "filter" script through flow builder branching filter', () => {
    ...
    test('Validate user is getting auto-fill of funtion stub while creating "filter" script through flow builder branching filte', async({io,page}) => {
     ...
     await page.getByText("Filter script").first().click(); // Adjust the position [1] as needed
