...
test.describe('C93688 Validate user is getting auto-fill of funtion stub while creating "preMap" script through flow builder branching filter', () => {
    ...
    test('Validate user is getting auto-fill of funtion stub while creating "preMap" script through flow builder branching filte', async({io,page}) => {
     ...
     await page.getByText("Pre map script").first().click(); // Adjust the position [1] as needed
