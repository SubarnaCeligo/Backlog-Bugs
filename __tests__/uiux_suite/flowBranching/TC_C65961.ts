...
test.describe.only("C65961 Verify UI throws an error message if the Path is wrong for DisplayAfter, and Verify that the UI throws error only in simple view if the Path is wrong in custom settings", () => {
