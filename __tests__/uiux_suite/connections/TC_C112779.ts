...
test.describe("C112779 - Verify the 'Create destination / lookup'(+ button above export bubble) page on flow builder screen when the search criteria does not yield any results.", () => {
    ...
    test("C112779 - Verify the 'Create destination / lookup'(+ button above export bubble) page on flow builder screen when the search criteria does not yield any results.", async ({ io, page }) => {
