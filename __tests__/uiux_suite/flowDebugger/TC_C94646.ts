...
test.describe("C94646_C94645", () => {
  test("C94646_C94645", async ({ io, page }) => {
    ...
    await io.flowBuilder.clickByText('TC_C94646');
    await io.flowBuilder.waitForElementAttached(selectors.flowBuilderPagePO.FLOW_TOGGLE);
    ...
    await io.flowBuilder.waitForElementAttached(selectors.flowBuilderPagePO.RDBMS_TABLE);
    await io.flowBuilder.click(selectors.flowBuilderPagePO.RDBMS_TABLE);
