...
test.describe("TC_C22560", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Navigate to Home Page ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("@Env-All @Zephyr-IO-T4630 TC_C22560", async ({io,page}, testInfo) => {
    ...
    test.step(" *** Verify that in create connection form the link to the respective connection guide is named as {{connector's Name}} connection guide *** ", async ()=>{});
