...
test.describe("TC_C22437", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("@Env-All @Zephyr-IO-T5836 TC_C22437", async ({io,page}, testInfo) => {
    ...
    await io.homePage.fill(selectors.connectionsPagePO.NAME_INPUT, "TC_C22473_First_API_Token");
    ...
    await io.homePage.fillWebPage(selectors.flowBuilderPagePO.SEARCHBUTTON,"TC_C22473_First_API_Token");
