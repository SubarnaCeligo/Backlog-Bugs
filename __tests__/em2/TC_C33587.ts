...
import NS from "@testData/EM2.0/TC_C33587.json";

test.describe("@Env-All @Zephyr-IO-T9796 TC_C33587", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.goToFlowsPage();
  });

  test("@Env-All @Zephyr-IO-T9796 TC_C33587", async ({io,page}, testInfo) => {
...
await test.step(
    ...
    test.step("Verified the error content in HTTP response", async ()=>{});
  });
});
