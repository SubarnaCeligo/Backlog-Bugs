...
test.describe("@Author-Shriti S Verify audit logs when user switches from account 'A' to account 'B'.", () => {
    ...
    test("@Env-All @Priority-P2 @Zephyr-IO-T17814 Verify audit logs when user switches from account 'A' to account 'B' (shared user with multiple owners).", async ({ io, page }) => {
