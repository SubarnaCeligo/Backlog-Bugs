...
test.describe("C57331 Verify if the shared user has not setup the MFA to his account he should be navigated to the MFA setup page on login", () => {
    test("@Env-All @Zephyr-IO-T17015 C57331 Verify if the shared user has not setup the MFA to his account he should be navigated to the MFA setup page on login", async ({io, page}) => {
