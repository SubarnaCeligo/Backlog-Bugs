...
test.describe(
  "C55951_C56164",
  () => {
    test("@Env-All @IO-T982 @IO-T1080 @IO-T7038 C55951_C56164 Verify when clicked on reset password link in(/reset-password:token?) in forgot password email error should be thrown if there is an active session in browser and /accept-invite:token?", async ({
      io,
      page
    }) => {
