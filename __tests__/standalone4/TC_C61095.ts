...
test.describe("TC_C61095", () => {
  ...
  test("TC_C61095 @Env-All @Zephyr-IO-T23125", async ({io,page}, testInfo) => {
    // C61095 Verify the prompt displayed when user updates the existing NS step when Selection is already set to Suite Bundle Suite Script 1.0 - Edit Lookup
    await io.homePage.loadingTime();
