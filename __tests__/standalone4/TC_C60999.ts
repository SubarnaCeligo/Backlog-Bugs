...
test.describe("TC_C60999_Verify that SuiteApp SuiteScript 1 option is clickable while creating new NS export and no suiteapp or suitebundle are installed", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("TC_C60999 @Env-All @Zephyr-IO-T23036", async ({io,page}, testInfo) => {
