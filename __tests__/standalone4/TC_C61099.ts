...
test.describe("TC_C61099", () => {
  ...
  test("TC_C61099 @Env-All @Zephyr-IO-T23128", async ({io,page}, testInfo) => {
    // C61099 Verify the prompt displayed when user updates the existing NS step when Selection is already set to Suite App Suite Script 1.0 or 2.x - Edit Lookup
    await io.homePage.loadingTime();
