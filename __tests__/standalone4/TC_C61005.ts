...
test.describe("TC_C61005_Verify that SuiteApp SuiteScript 1 option is clickable while creating new NS export and only suitebundle is installed", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("TC_C61005 @Env-All @Zephyr-IO-T23042", async ({io,page}, testInfo) => {
