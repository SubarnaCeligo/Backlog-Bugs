...
test.describe("TC_C60998_Verify Netsuite API version options while creating new NS export and no suiteapp or suitebundle are installed", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("TC_C60998 @Env-All @Zephyr-IO-T23035", async ({io,page}, testInfo) => {
