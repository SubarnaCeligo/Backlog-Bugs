...
test.describe("TC_C61094", () => {
  ...
  test("TC_C61094 @Env-All @Zephyr-IO-T23124", async ({io,page}, testInfo) => {
    // C61094 Verify the prompt displayed when user updates the existing NS step when Selection is already set to Suite Bundle Suite Script 1.0 - Edit Lookup
    await io.homePage.loadingTime();
