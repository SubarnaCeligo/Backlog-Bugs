...
test.describe("TC_C61098", () => {
  ...
  test("TC_C61098 @Env-All @Zephyr-IO-T23127", async ({io,page}, testInfo) => {
    // C61098 Verify the prompt displayed when user updates the existing NS step when Selection is already set to Suite App Suite Script 1.0 or 2.x - Edit Lookup
    await io.homePage.loadingTime();
