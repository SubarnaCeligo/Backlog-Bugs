...
test.describe("C77905 monitor To verify that the user should be able to create the Amazon/Salesforce oauth2.0 connection successfully.", () => {
...
test.afterEach(async ({ io }) => {
  ...
  test("C77905 monitor To verify that the user should be able to create the Amazon/Salesforce oauth2.0 connection successfully.", async ({ io, page }) => {
