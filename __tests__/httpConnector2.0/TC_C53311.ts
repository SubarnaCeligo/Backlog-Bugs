...
test.describe("TC_C53311 Verify user is able to click on handlebar icon for Inventory Resource", () => {
  ...
  test("@Zephyr-IO-T17106 @Env-All TC_C53311 Verify user is able to click on handlebar icon for Inventory Resource", async ({io,page}, testInfo) => {
