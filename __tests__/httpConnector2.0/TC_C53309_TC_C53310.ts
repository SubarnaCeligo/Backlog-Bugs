...
test.describe("TC_C53309_TC_C53310 Verify user is able to click on handlebar icon", () => {
  ...
  test("@Zephyr-IO-T17104 @Env-All TC_C53309 Verify user is able to click on handlebar icon for Billing Resource", async ({io,page}, testInfo) => {
  ...
  test("@Zephyr-IO-T17105 @Env-All TC_C53310 Verify user is able to click on handlebar icon for Customers Resource", async ({io,page}, testInfo) => {
    await io.flowBuilder.clickCreateFlowButton();
    await io.homePage.loadingTime();
    await io.homePage.isPageReady();
    await io.homePage.click(
