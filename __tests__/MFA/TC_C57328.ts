...
test.describe("C57328 Verify if we refresh the MFA setup page we should be staying on the same page and not navigated to other pages", () => {
  test("@Env-QA @Env-IAQA C57328 Verify if we refresh the MFA setup page we should be staying on the same page and not navigated to other pages", async ({io, page}) => {
