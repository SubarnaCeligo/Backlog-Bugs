...
test.describe("C45832 Verify if the user is not able to initiate the authentication until all the digits are entered.", () => {
  ...
  test("@Env-All @Zephyr-IO-T17240 C45832 The two-factor code is always 6 characters long", async ({ io, page }) => {
  ...
  test("@Env-All @Zephyr-IO-T17240 C45832 The user can enter only enter numeric digits for the code.", async ({ io, page }) => {
  ...
  test("@Env-All @Zephyr-IO-T17240 C45832 The user cannot initiate authentication until all the 6-digit code is provided by the user..", async ({ io, page }) => {
