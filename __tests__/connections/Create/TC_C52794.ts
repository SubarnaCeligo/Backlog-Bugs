...
test.describe("TC_C52794_Verify if the saving fails then the use should be able to do the save and authorize again in create connection page", () => {
  test("@Env-All TC_C52794_Verify if the saving fails then the use should be able to do the save and authorize again in create connection page UI_Backlog", async ({ io }, testInfo) => {
