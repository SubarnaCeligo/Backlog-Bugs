...
test.describe("TC_C41045_Verify if the Application field is set to GraphQL and the Media type to JSON_UI_Backlog", () => {
    test("TC_C41045_Verify if the Application field is set to GraphQL and the Media type to JSON_UI_Backlog", async ({ io },) => {
