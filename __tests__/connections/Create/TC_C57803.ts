...
test.describe("CONNECTIONS", () => {
    test("TC_C57803_Verify giving invalid base URI by unselecting the Configure refresh token checkbox and check whether the refresh token is generating or not", async ({ io }, testInfo) => {
