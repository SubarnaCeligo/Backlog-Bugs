...
test.describe("C26485 S3 - Verify 'PGP public key' field is mandatory when private key is not provided on connection", () => {
    test("@Env-All C26485 S3 - Verify 'PGP public key' field is mandatory when private key is not provided on connection", async ({ io, page }, testInfo) => {
