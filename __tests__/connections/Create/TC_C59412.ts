...
test.describe("TC_C59412_Verify scope section is not available in Shopify New and Existing connection in Production and Sandox", () => {
    test("TC_C59412_Verify scope section is not available in Shopify New and Existing connection in Production and Sandox UI_Backlog", async ({ io }, testInfo) => {
        ...
        await io.homePage.click(selectors.connectionsPagePO.SHOPIFY_APP);
