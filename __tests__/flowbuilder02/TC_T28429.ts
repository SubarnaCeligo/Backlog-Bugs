...
test.describe.skip("@Author_sagna123 TC_T28429_Test to validate checkbox is visible in HTTP export/lookup if we have exportSuccessMediaType is do not override and connectionSuccessMediaType is do not override and connectionMediaType is json", () => {
    test.beforeEach(async ({ io }) => {
        await io.myAccountPage.navigateTo(io.data.links.HOME_PAGE_URL);
    });
    test("@Epic-IO-37655 @Priority-P2 @Zephyr-IO-T28429 @Env-All", async ({ io, page }) => {
