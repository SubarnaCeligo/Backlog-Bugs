...
test.describe(`T2722 Metadata for ""Subscription Line"" record type is not available during Netsuite import flow @author_Kaushik UI_Backlog`, () => {
  test(`T2722 Metadata for ""Subscription Line"" record type is not available during Netsuite import flow @author_Kaushik UI_Backlog @Env-All @Priority-P2`, async ({ io, page }) => {
