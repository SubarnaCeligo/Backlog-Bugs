...
test.describe.skip("TC_T26975_Test to validate that user is able to see array of objects format on parsed output section when user specify the relative path on 'Path to records in HTTP response body' field if array of array structure is not there at the top level", () => {
