...
test.describe(`TC_C119815_C119816`, () => {
  ...
  test(`@Epic-IO-63762  @Priority-P2  @Zephyr-T24245 @Zephyr-T24246 @Env-All`, async ({ page, io }) => {
    ...
    expect(await page.screenshot()).toMatchSnapshot("TC_C119816-chromium-linux.png");
    await io.flowBuilder.click(selectors.basePagePO.CUSTOM_SETTING);
    ...
    expect(await buttonDis.screenshot()).toMatchSnapshot("TC_C119816 launchFormBuilder-chromium-linux.png");
    ...
    expect(await Symbol.screenshot()).toMatchSnapshot("TC_C119816 Lookup-chromium-linux.png");
    await io.flowBuilder.click(selectors.basePagePO.CUSTOM_SETTING);

    //-'Launch form builder' button should be displayed in 'Settings' section
    const buttonDis1 = await page.$(selectors.flowBuilderPagePO.SETTING);
    expect(await buttonDis1.screenshot()).toMatchSnapshot("TC_C119816 Lookup launchFormBuilder-chromium-linux.png");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.CLOSE);
    ...
    expect(await Symbol1.screenshot()).toMatchSnapshot("TC_C119816 Import-chromium-linux.png");
    await io.flowBuilder.click(selectors.basePagePO.CUSTOM_SETTING);

    //-'Launch form builder' button should be displayed in 'Settings' section
    const buttonDis2 = await page.$(selectors.flowBuilderPagePO.SETTING);
    expect(await buttonDis2.screenshot()).toMatchSnapshot("TC_C119816 Import launchFormBuilder-chromium-linux.png");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.CLOSE);
    ...
    expect(await buttonDi.screenshot()).toMatchSnapshot("TC_C119815 launchFormBuilder-chromium-linux.png");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.CLOSE);
    ...
    expect(await Symbo.screenshot()).toMatchSnapshot("TC_C119815 Lookup-chromium-linux.png");
    await io.flowBuilder.click(selectors.basePagePO.CUSTOM_SETTING);

    //-'Launch form builder' button should be displayed in 'Settings' section
    const buttonDi1 = await page.$(selectors.flowBuilderPagePO.SETTING);
    expect(await buttonDi1.screenshot()).toMatchSnapshot("TC_C119815 Lookup launchFormBuilder-chromium-linux.png");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.CLOSE);
    ...
    expect(await Symbo1.screenshot()).toMatchSnapshot("TC_C119815 Import-chromium-linux.png");
    await io.flowBuilder.click(selectors.basePagePO.CUSTOM_SETTING);

    //-'Launch form builder' button should be displayed in 'Settings' section
    const buttonDi2 = await page.$(selectors.flowBuilderPagePO.SETTING);
    expect(await buttonDi2.screenshot()).toMatchSnapshot("TC_C119815 Import launchFormBuilder-chromium-linux.png");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.CLOSE);
  });
});