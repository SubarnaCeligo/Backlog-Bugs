...
test.describe(`TC_IO-T26983  Test to validate that Yes/No options are working fine in "Was this helpful ?" section below the help text http export/lookup`, () => {
    ...
    test("IOT26983 @Env-All @Priority-P2 @Zephyr-IO-T26983", async ({ io }) => {
        ...
        await io.exportsPage.click(selectors.basePagePO.EXPLANATIONTHUMBSUP);
        await io.homePage.addStep("*** Click on Thumbs Up  ***");
        ...
        await io.exportsPage.click(selectors.basePagePO.EXPLANATIONTHUMBSDOWN);
        await io.homePage.addStep("*** Click on Thumbs Down  ***");
