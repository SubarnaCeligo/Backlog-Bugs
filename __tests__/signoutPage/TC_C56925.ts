...
test.describe("C56925 Verify the /request-reset?application=concur page is displaying correctly from the concur application", () => {
  ...
  test("@Env-All @Zephyr-IO-T1106 C56925 Verify the /request-reset?application=concur page is displaying correctly from the concur application", async ({ io, page }) => {
