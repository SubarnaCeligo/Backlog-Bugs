...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107853 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (DD-MONTH-YYYY hh:mm (24 hours))", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "06-March-2024 11    :38"}'
    );
