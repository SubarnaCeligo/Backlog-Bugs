...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107859 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (D-Mon-YYYY hh-mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "6-Mar-2024 11:38     AM"}'
    );
