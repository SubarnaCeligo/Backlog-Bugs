...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107886 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (YYYY-M-D hh-mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
