...
import NS_GDRIVE from "@testData/Flows/C107886.json";
...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107897 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (DD-Mon-YYYY hh:mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "12-Mar-2024 02:34 PM"}'
    );
