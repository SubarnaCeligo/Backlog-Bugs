...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107918 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (D MONTH, YYYY hh-mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "12 March, 2024 11    -15 AM"}'
    );
