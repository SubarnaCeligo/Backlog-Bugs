...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107903 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (DD.MM.YYYY hh-mm (24 hours))", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "07.03.2024 01-33     PM"}'
    );
