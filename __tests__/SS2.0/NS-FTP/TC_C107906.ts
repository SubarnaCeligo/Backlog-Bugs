...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107906 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (D/M/YYYY hh-mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
