...
test.describe("SS2.0 Flows", () => {
  ...
  test("TC_C107893 Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (MM/DD/YYYYhh:mm AM/PM)", async ({
    io,
    page
  }, testInfo) => {
    ...
    await io.assert.verifyElementContainsText(
      ...
      '{  "CreatedDate": "05/03/202403:56     PM"}'
    );
