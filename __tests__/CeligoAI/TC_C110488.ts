...
test.describe("C110488 Verify system generates the MS SQL query after the user has provided the prompt", () => {
  test("C110488 Verify system generates the MS SQL query after the user has provided the prompt", async ({io, page}) => {
    ...
    await io.flowBuilder.fill(selectors.basePagePO.INPUT_NAME_SELECTOR, 'MSSQL AI');
