...
test.describe("C119632 Verify the Celigo AI functionality working fine for MySQL", () => {
  test("C119632 Verify the Celigo AI functionality working fine for MySQL", async ({io, page}) => {
    ...
    await io.flowBuilder.fill(selectors.basePagePO.INPUT_NAME_SELECTOR, 'MYSQL AI');
