...
test.describe("C112698 Verify Mapper2.0 is having Celigo AI", () => {
  ...
  test("@Env-All C112698 Verify Mapper2.0 is having Celigo AI", async ({
    io,
    page
  }) => {
    ...
    const isCeligoAINotVisibleInMapper1 = !(await io.flowBuilder.isVisible(
      selectors.flowBuilderPagePO.OPENAI.CELIGO_AI_HELPTEXT
    ));
    await io.assert.expectToBeTrue(
      isCeligoAINotVisibleInMapper1,
      "Celigo AI Not Visible for Mapper 1.0"
    );
    ...
    const placeholderText = page
      .getByPlaceholder(
        "Tell me about your mapping here... I will apply your request to the existing mapping unless you tell me to replace it"
      )
      .first();
