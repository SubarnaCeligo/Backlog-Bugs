...
test.describe("IO-T31906 Verify Celigo AI is displayed in transformation2.0 tab", () => {
  ...
  test("@Env-QA @Zephyr-IO-T31906 @Zephyr-IO-T31907 @Zephyr-IO-T31908 @Zephyr-IO-T31909 @Zephyr-IO-T31910 Verify Celigo AI is displayed in transformation2.0 tab", async ({ io, page }) => {
  ...
  test("@Env-QA @Zephyr-IO-T32427 Verify auto transform Icon is added for transformation2.0", async ({ io, page }) => {
    await io.homePage.navigateTo(process.env["IO_Integration_URL"]);
    await io.flowBuilder.loadingTime();
    await io.flowBuilder.clickByText('TC47946_DND');
    await io.flowBuilder.loadingTime();
  ...
  test("@Env-QA @Zephyr-IO-T324", async ({ io, page }) => {
    await io.homePage.navigateTo(process.env["IO_Integration_URL"]);
    await io.flowBuilder.loadingTime();
