...
test.describe("IO-T32859  Verify user is able to use celigo AI in SQL editor for Azure Synapse Connector", () => {
  test("@Env-All @StoryID-IO-82077 @Zephyr-IO-T32859 @Zephyr-IO-T32872 @Zephyr-IO-T32860 @Zephyr-IO-T32861 @Zephyr-IO-T32862 @Zephyr-IO-T32863 @Author-SubarnaGhatak Verify user is able to use celigo AI in SQL editor for Azure Synapse Connector", async ({io, page}) => {
  ...
  test("@Env-All @StoryID-IO-82077 @Zephyr-IO-T32874 @Author-SubarnaGhatak Verify the Celigo AI functionality working fine for Dynamic lookup", async ({io, page}) => {
