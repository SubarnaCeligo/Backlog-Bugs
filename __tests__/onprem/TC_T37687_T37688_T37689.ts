...
test.describe("T37687_T37688_T37689 Verify new UI for MsSQL, MySQL, PostgreSQL import with on-premise connection", () => {
  ...
  test("@Epic-IO-46210 @Env-All  @Priority-P2 @Zephyr-IO-T37688 T37689_Verify new UI for PostgreSQL import with on-premise connection", async ({ io, page }) => {
  ...
  test("@Epic-IO-46210 @Env-All @Priority-P2 @Zephyr-IO-T37687 T37687_Verify new UI for MySQL import with on-premise connection", async ({ io, page }) => {
    await io.homePage.loadingTime();
    await io.homePage.goToMenu("Tools", "Flow builder");
    await io.homePage.addStep("*** Click on add destination or lookup ***");
    await io.flowBuilder.click(
  ...
  test("@Epic-IO-46210 @Env-All @Priority-P2 @Zephyr-IO-T37688 T37688_Verify new UI for MsSQL import with on-premise connection", async ({ io, page }) => {
    await io.homePage.loadingTime();
    await io.homePage.goToMenu("Tools", "Flow builder");
    await io.homePage.addStep("*** Click on add destination or lookup ***");
    await io.flowBuilder.click(
