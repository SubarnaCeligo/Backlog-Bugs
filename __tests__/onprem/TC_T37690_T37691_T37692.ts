...
test.describe("T37690_T37691_T37692 Verify old UI for existing PostgreSQ, MsSQL, MySQL import with on-premise connection", () => {
  ...
  test("@Epic-IO-46210 @Env-QA @Priority-P2 @Zepehyr-IO-T37690 T37690_Verify old UI for existing MySQL import with on-premise connection", async ({ io, page }) => {
  ...
  test("@Epic-IO-46210 @Env-QA @Priority-P2 @Zepehyr-IO-T37691 T37691_Verify old UI for existing MsSQL import with on-premise connection", async ({ io, page }) => {
  ...
  test("@Epic-IO-46210 @Env-QA @Priority-P2 @Zepehyr-IO-T37692 T37692_Verify old UI for existing PostgreSQL import with on-premise connection", async ({ io, page }) => {
