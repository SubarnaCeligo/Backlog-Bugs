...
import flowbranch from "@testData/flowbranching/TC_C47559.json";

test.describe("@Author-ParthPatel TC_C47559", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17641 TC_C47559 Test to retry error when pathToMany is set to invalid value", async ({io,page}, testInfo) => {
    ...
    await io.homePage.fillWebPage(
      selectors.importPagePO.PATHTOMANY,
      "batters.batter"
    );
