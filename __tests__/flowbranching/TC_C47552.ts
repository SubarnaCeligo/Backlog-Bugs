...
import flowbranch from "@testData/flowbranching/TC_C47552.json";

test.describe("@Author-ParthPatel TC_C47552_Flowbranching", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17634 TC_C47552 Test to retry an error occured on a SF import added on a branch", async ({io,page}, testInfo) => {
