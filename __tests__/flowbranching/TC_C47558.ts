...
import flowbranch from "@testData/flowbranching/TC_C47558.json";

test.describe("@Author-ParthPatel TC_C47558_Flowbranching", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17640 TC_C47558 Test to retry multiple errors occured on a export added on a flow branch (when page size set)", async ({io,page}, testInfo) => {
    ...
    expect(errors.includes("11 errors")).toEqual(true);
    await io.homePage.loadingTime();
