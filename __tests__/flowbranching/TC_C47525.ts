...
import TC from "@testData/flowbranching/TC_C47525.json";

test.describe("@Author-ParthPatel TC_C47525", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17607 TC_C47525 Test to add a second PP on a branch, add a response mapping and then add a router with atleast two branches", async ({io,page}, testInfo) => {
