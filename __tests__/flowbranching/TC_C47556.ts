...
import flowbranch from "@testData/flowbranching/TC_C47556.json";

test.describe("@Author-ParthPatel TC_C47556", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17638 TC_C47556 Test to retry an error occured on a import added after two branches are merged", async ({io,page}, testInfo) => {
