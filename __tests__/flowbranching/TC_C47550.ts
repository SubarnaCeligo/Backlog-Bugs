...
import flowbranch from "@testData/flowbranching/TC_C47550.json";
  

test.describe("@Author-ParthPatel TC_C47550", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17632 TC_C47550 Test to retry an error (error due to hooks) on the import added on a branch", async ({io,page}, testInfo) => {
    ...
    await io.homePage.clickButtonByIndex(selectors.flowBuilderPagePO.PAGE_PROCESSOR_HOOKS,0);
    await io.homePage.loadingTime();
