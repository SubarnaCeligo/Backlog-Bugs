...
import flowbranch from "@testData/flowbranching/TC_C47543.json";

test.describe("@Author-ParthPatel TC_C47543", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17625 TC_C47543 | Test to retry an error on the FTP export which is added on a branched flow  ", async ({io,page}, testInfo) => {
