...
import flowbranch from "@testData/flowbranching/TC_C47457.json";

test.describe("@Author-ParthPatel TC_C47457_import_Error_retry Test to set 'Proceed to Failure' as false and 'oneToMany' as false on the import on a branch and then also validate the error retry.", () => {
  let flowId;
  ...
  test("@Env-All @Zephyr-IO-T17526 TC_C47457_import_Error_retry", async ({io,page}, testInfo) => {
