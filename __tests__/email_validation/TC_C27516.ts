...
test.describe("C27516 User is navigated to sandbox after clicking on a link received from EM 2.0 flow error notification.", () => {
    ...
    test("C27516 User is navigated to sandbox after clicking on a link received from EM 2.0 flow error notification.", async ({io, page}) => {
      ...
      const res = await io.emailVal.getLinkFromEmail("1 new error: TC_C27516",true);
