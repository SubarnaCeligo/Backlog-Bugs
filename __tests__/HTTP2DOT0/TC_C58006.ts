...
test.describe("IO-58006 scenarios", () => {
  test("Verify if toggle persists when user open iclient from Connections", async ({ io, page, context }) => {
    ...
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTS_ID,decrypt('MjExOWY2MWItMzgyNS00NTM0LTliMmUtOWYxZTBhNjNjYWFj') );
    ...
    await save[1].click();
    await io.homePage.loadingTime();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.CLIENTS_ID)).isVisible(), "Saved in Simple View Mode");
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTSECRET3PL,decrypt('TG9xazJFbVovMno5L2xGNk9COFB3aUh2dzdGbW1IaHA='));
    ...
    await io.homePage.loadingTime();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.CLIENTS_ID)).isVisible(), "Saved in Simple View Mode");
    const HTTP = await page.$$(selectors.connectionsPagePO.HTTP_CNNECTOR);
    await HTTP[2].click();
    await io.homePage.loadingTime();
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTSECRET3PL,decrypt('TG9xazJFbVovMno5L2xGNk9COFB3aUh2dzdGbW1IaHA='));
    ...
    await io.homePage.loadingTime();
    await io.flowBuilder.fill(selectors.connectionsPagePO.USERNAM3PL, "b779b82f-f5e5-4d59-a2c9-ea2c5eb8eec3");
    ...
    await io.flowBuilder.fill(selectors.exportsPagePO.CONNECTIONS_DROPDOWN, randomString);
    await io.flowBuilder.click(selectors.connectionsPagePO.CONNECTIONDROPDOWNMENU);
    await io.flowBuilder.loadingTime();
    ...
    await edit7[1].click();
    await io.homePage.loadingTime();
    const simple1 = await page.$$(selectors.flowBuilderPagePO.SIMPLE_FORM_SWITCH);
    await simple1[2].click();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.CLIENTS_ID)).isVisible(), "Saved in Simple View Mode");
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTSECRET3PL,decrypt('TG9xazJFbVovMno5L2xGNk9COFB3aUh2dzdGbW1IaHA='));
    ...
    await edit2[1].click();
    await io.homePage.loadingTime();
    const simple = await page.$$(selectors.flowBuilderPagePO.SIMPLE_FORM_SWITCH);
    await simple[2].click();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.CLIENTS_ID)).isVisible(), "Saved in Simple View Mode");
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTSECRET3PL,decrypt('TG9xazJFbVovMno5L2xGNk9COFB3aUh2dzdGbW1IaHA='));
    ...
    await io.homePage.loadingTime();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.CLIENTS_ID)).isVisible(), "Saved in Simple View Mode");
    const HTTP5 = await page.$$(selectors.connectionsPagePO.HTTP_CNNECTOR);
    await HTTP5[2].click();
    await io.homePage.loadingTime();
    await io.assert.expectToBeTrue(await (await page.$(selectors.connectionsPagePO.ENABLEJWTHTTP)).isVisible(), "HTTP View is not displayed");
    await io.flowBuilder.fill(selectors.connectionsPagePO.CLIENTSECRET3PL,decrypt('TG9xazJFbVovMno5L2xGNk9COFB3aUh2dzdGbW1IaHA='));
