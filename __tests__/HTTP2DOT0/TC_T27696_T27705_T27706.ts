...
test.describe('TC_T27696_T27705_T27706', () => {
    ...
    test('@Env-All IO-T27696 Verify if able to create NSAW connection', async ({ io, page }) => {
    ...
    test.skip('@Env-All IO-T27705 Verify authentication field is not shown for NSAW connector and user is able to create connection in Sandbox', async ({ io, page }) => {
    ...
    test('@Env-All IO-T27706 Verify NSAW connection creation from exports and imports', async ({ io, page }) => {
