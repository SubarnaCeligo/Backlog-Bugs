...
test.describe("T31950 - Verify the new section should only be shown in the UI when the user selects 'export records from source application' under 'What would you like to export?' while creating a new export.", () => {
  test("@Zephyr-IO-T31950 @Env-Platform4 @Epic-IO-35739 @Priority-P2 - Verify the new section should only be shown in the UI when the user selects 'export records from source application' under 'What would you like to export?' while creating a new export.", async ({ io, page }) => {
