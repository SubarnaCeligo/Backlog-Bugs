...
test.describe('TC_T27692_T27693_T27694', () => {
    ...
    test.skip('IO-T27692 Verify authentication field is not shown for NSAW & Oracle ADW connectors while creating connections', async({ io }) => {
        ...
        await io.homePage.click(selectors.basePagePO.ADD_NEW_RESOURCE);
        await io.connectionPage.click(selectors.connectionsPagePO.ORACLE_AUTONOMOUS_DATABASE);
        await io.assert.verifyElementNotBeFound(selectors.connectionsPagePO.JDBC_AUTH_TYPE);
    });

    test.skip('IO-T27693 Verify authentication field is not shown while creating & editing Oracle Autonomous Database connection', async({ io }) => {
    ...
    test.skip('IO-T27694 Verify authentication field is not shown while editing NetSuite Analytics Warehouse (NSAW) connection', async({ io }) => {
