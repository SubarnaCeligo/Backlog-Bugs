...
import FTP from "@testData/STANDALONE/TC_C50807.json";

test.describe("TC_C50807_Verify_Snowflake_FTP_Export_Error_Details", () => {
  let flowId: string;
  ...
  test("@Zephyr-IO-T22234 @Env-All TC_C50807_Verify_Snowflake_FTP_Export_Error_Details", async ({io,page}, testInfo) => {
    // *Create flow
    ...
    await io.api.verifyFlowStatusThroughAPI('TC_C50807_Verify_Snowflake_FTP_Export_Error_Details', flowId, [0,0,1]);
    await io.homePage.loadingTime();
