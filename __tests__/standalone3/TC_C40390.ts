...
test.describe("TC_C40390_Verify_edit_mock", () => {
  test("@Zephyr-IO-T5916 @Env-All TC_C40390_Verify_edit_mock", async ({io,page}, testInfo) => {
    ...
    await io.homePage.fillWebPage(selectors.mappings.MAPPER2DOT0PO.PREVIEWRESOURCE, '{"name":"Celigo"}');
    ...
    test.step("*** Verified User should able to add their own data manually. ***", async ()=>{});
