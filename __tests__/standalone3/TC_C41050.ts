...
import HTTP from "@testData/STANDALONE/TC_C41050.json";

test.describe("TC_C41050_success_message", () => {
  let flowId: string;
  ...
  test("@Zephyr-IO-T5933 @Env-All TC_C41050_success_messaget", async ({io,page}, testInfo) => {
    ...
    // enter 'id' as the 'Which field?' value to ensure a new record is created
    ...
    await io.assert.expectToContainValue("\"method\": \"POST\"",reqBody, "");
