...
import HTTP from "@testData/STANDALONE/TC_C41049.json";

test.describe("TC_C41049_success_message", () => {
  let flowId: string;
  ...
  test("@Zephyr-IO-T5932 @Env-All TC_C41049_success_message", async ({io,page}, testInfo) => {
