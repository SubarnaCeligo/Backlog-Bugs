...
test.describe("TC_C40401_Verify_edit_mock", () => {
  test.beforeEach(async ({io,page}, testInfo) => {
    test.step("*** Beginning of Test Suite ***", async ()=>{});
    await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
  });
  test("@Zephyr-IO-T5926 @Env-All TC_C40401_Verify_edit_mock", async ({io,page}, testInfo) => {
    ...
    test.step("*** Verified edit mock input validations for wrong Json ***", async ()=>{});
