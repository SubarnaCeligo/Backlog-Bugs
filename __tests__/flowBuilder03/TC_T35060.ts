...
test.describe("Verify user is able to access the execution details(testMode field) via handlebar in Export AFE screens", () => {
    let flowMap;
    test("@Env-All @Zephyr-IO_T35060 @Zephyr-IO_T35061 @Zephyr-IO-35063 @Zephyr-IO-35068 IO-35069 @Priority-P2 Verify user is able to access the execution details(testMode field) via handlebar in Export AFE screens", async ({
        io, page
    }, testInfo) => {
