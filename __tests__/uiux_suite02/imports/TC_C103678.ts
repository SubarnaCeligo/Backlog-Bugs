...
test.describe("C103678 Verify Help Text for HTTP request body", () => {
  ...
  test("C103678 Verify Help Text for HTTP request body", async ({ io, page }) => {
    ...
    await io.flowBuilder.clickByText('HTTP AMAZON CONNECTION');
