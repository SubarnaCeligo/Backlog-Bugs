...
test.describe(`C30482_Verify support for record type 'price plan' in search criteria and import as well_UI_Backlog`, () => {
  test(`C30482_Verify support for record type 'price plan' in search criteria and import as well_UI_Backlog`, async ({ io, page}) => {
