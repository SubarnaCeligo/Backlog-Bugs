...
test.describe("C63406 Verify when Number of records per HTTP Import request is set to greater than 1 then the field 'Path to records in HTTP response body' under Non-standard API response patterns should be set to required.", () => {
  test("@Env-All C63406 Verify when Number of records per HTTP Import request is set to greater than 1 then the field 'Path to records in HTTP response body' under Non-standard API response patterns should be set to required.", async ({io, page}) => {
