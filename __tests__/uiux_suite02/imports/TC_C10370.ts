...
test.describe("TC_C103070 Verify Based on the selection from the simple view, the details  will be automatically updated in the HTTP view", () => {
    ...
    test("@Zephyr-T24471 @Env-Staging @Env-QA @Priority-P2 TC_C103070 Verify Based on the selection from the simple view, the details  will be automatically updated in the HTTP view.", async ({ io, page }) => {
