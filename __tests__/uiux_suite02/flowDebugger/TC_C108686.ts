...
test.describe("TC_C108686 Verify Editing / reordering / restructuring transformation rules should clear test run results.", () => {
  let transform;
  let id;
  ...
  test("@Env-All C108686 Verify Editing / reordering / restructuring transformation rules should clear test run results.", async ({
    io,
    page
  }) => {
