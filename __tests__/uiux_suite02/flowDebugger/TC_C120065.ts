...
test.describe(`TC_C120065_C120066_C120067_C120076_C120078_C120079_C120080_C120068_C120081_C120090_C120092_C120091_C120093_C120094`, () => {
  ...
  test(`TC_C120065_C120066_C120067_C120076_C120078_C120079_C120080_C120068_C120081_C120090_C120092_C120091_C120093_C120094`, async ({ io, page }) => {
    ...
    expect(previewTextPOST).toContain("{  \"page_of_records\": [    {      \"record\": {        \"_raw\": \"File written successfully\"      }    }  ]}");
    await io.connectionPage.addStep("Verified the preview the HTTP request/response in the Preview panel");
    ...
    expect(transformationTextPOST).toContain("{  \"_raw\": \"File written successfully\"}");
    await io.connectionPage.addStep("Verified the parsed response is available for the next steps within the flow builder");
    ...
    await io.flowBuilder.click(selectors.importPagePO.EXPAND_MOCK_RESPONSE);
    await io.connectionPage.addStep("Expanding the mock response");
    await io.flowBuilder.click(selectors.flowBuilderPagePO.POPULWITHMOCKRESP1);
    await io.connectionPage.addStep("Populating with mock response");
    ...
    expect(responseMappingText).toContain("\"_json\": {    \"_raw\": \"File written successfully\"  }");
