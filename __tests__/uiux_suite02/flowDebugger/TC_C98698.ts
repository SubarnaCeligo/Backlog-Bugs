...
test.describe("C98698 Verify on toggling from test result to rules preview is empty", () => {
    test("C98698 Verify on toggling from test result to rules preview is empty", async ({ io, page }) => {
