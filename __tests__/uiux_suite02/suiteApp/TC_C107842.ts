...
test.describe("TC_C107842_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (YYYY-MM-DD hh:mm AM/PM)", () => {
    ...
    test("TC_C107842_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (YYYY-MM-DD hh:mm AM/PM) UI_Backlog", async ({ io, page }, testInfo) => {
