...
test.describe("TC_C107844_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (YYYY-MM-DD hh-mm (24 hours))", () => {
    ...
    test("TC_C107844_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (YYYY-MM-DD hh-mm (24 hours)) UI_Backlog", async ({ io, page }, testInfo) => {
