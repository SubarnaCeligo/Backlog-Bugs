...
test.describe(`C61153 Verify If all the NS steps in my integration are solely configured to use SuiteBundle then only the SuiteBundle installation step has to be shown in the install steps.`, () => {
  test(`@Env-All C61153 Verify If all the NS steps in my integration are solely configured to use SuiteBundle then only the SuiteBundle installation step has to be shown in the install steps.`, async ({
    page,
    io
  }) => {
