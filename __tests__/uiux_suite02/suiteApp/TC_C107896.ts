...
test.describe("TC_C107896_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (MM/DD/YYYY hh:mm (24 hours))", () => {
    ...
    test("@Env-All TC_C107896_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (MM/DD/YYYY hh:mm (24 hours)) UI_Backlog", async ({ io, page }, testInfo) => {
