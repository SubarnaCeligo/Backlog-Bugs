...
test.describe("TC_C107907_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (D/M/YYYY hh-mm (24 hours))", () => {
    ...
    test("TC_C107907_Verify syncing dateTime fields in NS SS2.x import flows based on Date format added in the settings (D/M/YYYY hh-mm (24 hours)) UI_Backlog", async ({ io, page }, testInfo) => {
