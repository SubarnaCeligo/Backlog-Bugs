...
test.describe(`C61021 Verify the prompt displayed on selecting ‘SuiteBundle SuiteScript 1.0 (to be deprecated)’ option of NetSuite API Version’ options while creating new NS import`, () => {
  test(`@Env-All @Zephyr-IO-T23058 C61021 Verify the prompt displayed on selecting ‘SuiteBundle SuiteScript 1.0 (to be deprecated)’ option of NetSuite API Version’ options while creating new NS import`, async ({
    io,
    page
  }) => {
    ...
    await io.assert.expectToContainValue( "Install the Integrator.io SuiteApp in your NetSuite account  to integrate with SuiteScript APIs.", errorText.toString(), "SuiteApp install message is not displayed")
