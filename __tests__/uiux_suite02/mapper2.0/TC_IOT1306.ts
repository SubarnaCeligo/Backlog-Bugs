...
test.describe(`IOT1306 - To verify metadata is getting populated when record type is selected as Subscription change order in Netsuite Import flow UI_Backlog`, () => {
  test(`@Env-All IOT1306 - To verify metadata is getting populated when record type is selected as Subscription change order in Netsuite Import flow UI_Backlog`, async ({
    io,
    page
  }) => {
