...
test.describe(`C77814 Validate User is able to see the more actions icon when download retry data option is available (Manager account)`, () => {
    test(`@Env-All @Zephyr-IO-T21621 C77814 Validate User is able to see the more actions icon when download retry data option is available (Manager account)`, async ({
      io,
      page
    }) => {
