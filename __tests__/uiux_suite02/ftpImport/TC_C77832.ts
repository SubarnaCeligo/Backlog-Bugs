...
test.describe(`C77832 Validate User is not seeing the more actions when download retry data option is not available (Administer  account)`, () => {
    test(`@Env-All @Zephyr-IO-T21639 C77832 Validate User is not seeing the more actions when download retry data option is not available (Administer  account)`, async ({
      io,
      page
    }) => {
