...
test.describe("C57329 Verify after login, all pages should render without any redirect and should stay on the same pages", () => {
    test("@Env-All C57329 Connections Page.", async ({io, page}) => {
    ...
    test("@Env-All C57329 Imports Page.", async ({io, page}) => {
      await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
      await io.homePage.waitForElementAttached(selectors.basePagePO.RESOURCES);
    ...
    test("@Env-All C57329 Exports Page.", async ({io, page}) => {
      await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
      await io.homePage.waitForElementAttached(selectors.basePagePO.RESOURCES);
    ...
    test("@Env-All C57329 Agents Page.", async ({io, page}) => {
      await io.homePage.navigateTo(io.data.links.HOME_PAGE_URL);
      await io.homePage.waitForElementAttached(selectors.basePagePO.RESOURCES);
    ...
    test("@Env-All C57329 Integration Page.", async ({io, page}) => {
