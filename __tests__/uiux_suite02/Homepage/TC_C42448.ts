...
test.describe("C42448_Verify “Request trial extension” and “compare plans” buttons/text is removed from Subscriptions tab for license type=integrator", () => {
    test("C42448_Verify “Request trial extension” and “compare plans” buttons/text is removed from Subscriptions tab for license type=integrator UI_Backlog", async ({ io, page }) => {
